...
const TagsPage: React.FC<TagsPageProps> = ({ onBack }) => {
    return (
        <div className="pb-20">
            <SubPageHeader title="Теги" onBack={onBack} />
            <div className="flex flex-col items-center justify-center h-[calc(100vh-150px)] text-center text-gray-500">
                <TagsIcon className="w-24 h-24 mb-4" />
                <h2 className="text-xl font-semibold text-gray-300">Управление тегами</h2>
